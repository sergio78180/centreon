...
ALTER TABLE `cfg_hosts_services_relations` DROP FOREIGN KEY `cfg_hosts_services_relation_ibfk_1`;
...
ALTER TABLE `cfg_traps` DROP FOREIGN KEY `cfg_traps_ibfk_2`;
ALTER TABLE `cfg_traps_matching_properties` DROP FOREIGN KEY `cfg_traps_matching_properties_ibfk_2`;
ALTER TABLE `cfg_hosts_services_relations` DROP FOREIGN KEY `cfg_hosts_services_relations_ibfk_3`;