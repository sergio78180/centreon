...
New features
------------
Several new featuress make their appearance with Centreon Broker:
...
..entreon web interface is made up of several menus, each menu has a specific function:
...
*       The **Administration** menu serves to configured the Centreon web interface and to view the general status of the servers.
